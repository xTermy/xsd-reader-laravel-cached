...
class TypeInheritanceTest extends BaseTest
{
    public function testInheritanceWithExtension()
    {
        $schema = $this->reader->readString('
            ...
            ');
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\ComplexType', $type1 = $schema->findType('complexType-1', 'http://www.example.com'));
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\ComplexType', $type2 = $schema->findType('complexType-2', 'http://www.example.com'));

        $this->assertSame($type1, $type2->getExtension()->getBase());

        $elements = $type2->getElements();
        $attributes = $type2->getAttributes();
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Element\Element', $elements[0]);
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Attribute\Attribute', $attributes[0]);
    ...
    public function testBase()
    {
        ...
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\SimpleType', $type = $schema->findType('mySimple', 'http://www.example.com'));
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\SimpleType', $type2 = $schema->findType('mySimpleWithRestr', 'http://www.example.com'));
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\ComplexTypeSimpleContent', $type3 = $schema->findType('myComplex', 'http://www.example.com'));
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\SimpleType', $type4 = $schema->findType('mySimpleWithUnion', 'http://www.example.com'));

        $restriction1 = $type->getRestriction();
        $base1 = $restriction1->getBase();
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\SimpleType', $base1);
        ...
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\SimpleType', $unions[0]);
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\SimpleType', $unions[1]);
    ...
    public function testAnonyeExtension()
    {
        ...
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\SimpleType', $type = $schema->findType('myType', 'http://www.example.com'));

        $restriction = $type->getRestriction();
        $base = $restriction->getBase();
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\SimpleType', $base);
    ...
    public function testAnonymUnion()
    {
        ...
        $this->assertInstanceOf('CollectHouse\XML\XSDReader\Schema\Type\SimpleType', $type = $schema->findType('myAnonUnion', 'http://www.example.com'));
